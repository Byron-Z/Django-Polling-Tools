...
SECRET_KEY = 'v$hq44z^()$f6*zn_psewzi)%2zc8c+rj8uiy-$gn7eomgp)=2'
...
DATABASE_ROUTERS = ['survey.routers.TOMRouter',]
...
STATIC_ROOT = '/opt/survey/survey/static'

STATICFILES_DIRS = (
    '/opt/survey/polls/static',
...
SESSION_FILE_PATH = '/opt/survey/sessions'
